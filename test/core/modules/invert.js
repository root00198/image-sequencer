...
var invert = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAAklEQVR4AewaftIAAAApSURBVKXBAQEAAAiDMKR/5xuC7W4bgUQSSSSRRBJJJJFEEkkkkUQSSfRkrAMeYVgCHwAAAABJRU5ErkJggg==';
...
test('Invert module produces correct output', function(t) {
  sequencer.run({ mode: 'test' }, function(out) {
    ...
    t.equal(result === benchmark, true, 'Invert module works correctly with png');
    sequencer = null;
    t.end();
  });
});